...
rule peak_annotation:
    ...
    params:
        ...
        distance2 = config["distance2"]
    shell:
        "python chipseq_gene_annotation_V2.1.py -peak_file {input.peak} -gff {input.gff} -o {params.o} -distance1 {params.distance1} -distance2 {params.distance2} -type1_method {params.type1_method}"
